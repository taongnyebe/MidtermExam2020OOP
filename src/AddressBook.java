...
public class AddressBook {
	...
	private final int STATEAVAILABLE = 0;
	private final int NOTINUSE = 0;
	...
	public AddressBook(int MaxEntry)
	{
	...
	public void SubMenuUI()
	{
		...
		while(!back)
		{
			System.out.println("\n\n\n\n");
			System.out.println("--------------------------------");
			System.out.println("Activty 3: Address Book");
			System.out.println("--------------------------------");
